                ...
                <table class="" style="width: 100%;" border="0">
                    <tr style="border-bottom: 1px solid #c1c1c1;">
                        <th class="a20"><img class="login-logo login-6"
                                             src="{{ url('/') }}/assets/pages/img/lifepet-logotipo-lilas-800px.png"
                        ...
                        <th class="a40">
                            <h4 style="font-weight: 700; text-align: left;">
                                <p>
                                    ...
                                    <b> Pet:</b>
                                    {{ $guia->id_pet . " - " . $guia->pet()->first()->nome_pet  }}
                                    <br>
                                    <b> Idade/Raça:</b>
                                    {{ $historicos->first()->pet->data_nascimento->age . " anos / " . ($historicos->first()->pet->tipo == 'GATO' ? 'Gato' : 'Cão'). ' / ' . $historicos->first()->pet->raca->nome . " / " . ($historicos->first()->pet->sexo == "F" ? "Fêmea" : "Macho") }}
                                </p>
                            </h4>
                        </th>
                        <th class="a40">
                    ...
                    <table class="" style="width: 100%;margin-top: 30px;border-radius:10px !important;" border="0">
                        ...
                        <tr>
                            <td class="a33 cell-assinar" style="margin-right: 25px !important;width: 45%;float: left;">
                                ...
                                @elseif($guia->meio_assinatura_cliente == \Modules\Guides\Entities\HistoricoUso::MEIO_ASSINATURA_PRESENCIAL)
                                    <div class="assinatura-digital">
                                        <div class="icone-assinatura">
                                            <i class="icon-check"></i>
                                        </div>
                                        <div class="dados-assinatura">
                                            <h5><strong>{{ $prestador->nome }}</strong></h5>
                                            <h5>
                                                @if($guia->tipo_atendimento === \Modules\Guides\Entities\HistoricoUso::TIPO_ENCAMINHAMENTO)
                                                    {{ $guia->realizado_em->format('d/m/Y H:i:s') }}
                                                @else
                                                    {{ $guia->created_at->format('d/m/Y H:i:s')  }}
                                                @endif
                                            </h5>
                                            <h5>Assinado Presencialmente</h5>
                                        </div>
                                    </div>
                                @else
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('autorizador.assinarGuiaCliente') }}" method="POST" id="form-assinarCliente">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-md-offset-3">
                                ...
                                <small class="helper">Sua senha é composta pelos 4 primeiros dígitos do seu CPF</small>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('autorizador.assinarGuiaPrestador') }}" method="POST"
                          id="form-assinarPrestador">
                        {{ csrf_field() }}
                        <input type="hidden" name="numero_guia" value="{{ $guia->numero_guia }}">
                        <div class="row">
                            <div class="col-md-12">
