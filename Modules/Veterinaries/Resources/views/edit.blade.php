...
@section('title')
    @parent
    Prestadores - Editar - {{ $prestadores->nome }}
@endsection
@section('content')
    ...
    <div class="portlet light portlet-fit portlet-form ">
        <div class="portlet-title">
            ...
            @permission('edit_prestadores')
            <div class="actions" data-target="#prestadores">
        ...
        <div class="portlet-body">
            ...
            !!}
                <div class="form-body">
                    ...
                    @include('veterinaries::fields', ['prestadores' => $prestadores])
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var $actions = $('.actions[data-target="#prestadores"]');
            ...
            $actions.find('#cancel').click(function() {
                var target = $actions.attr('data-target');
                location.href = "{!! route('prestadores.index') !!}";
                return;
            });
        });
    </script>
