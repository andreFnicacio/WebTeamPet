...
class MontlyPlan extends Transformable
{
    ...
    public $FL_BOLETO_PLA = 1; //1 Number. 1 para ativar pagamento por boleto e 0 para desativar.
    ...
    {
        $nomePlano = "{$plano->nome_plano} - #{$plano->id} - MENSAL";
        ...
        $this->COMPO_RECEBIMENTO = [
            [
                ...
                'VL_UNITARIO_PRD' => number_format($plano->preco_plano_individual, 2) ?? 99
            ]
        ];
    }
}