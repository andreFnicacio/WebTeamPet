...
class YearlySignature extends Transformable
{
    const ID_PRODUTO_ANUALIDADE = 3;
    ...
    public function __construct(Pets $pet)
    {
        ...
        if($signature->data_encerramento_contrato) {
        ...
        $this->PLANOS = [
            [
                'ID_PLANO_PLA' => $plano->id_superlogica_anual,
                'FL_TRIAL_PLC' => 0,
        ...
        $this->OPCIONAIS = [
            [
                'ID_PRODUTO_PRD' => self::ID_PRODUTO_ANUALIDADE,
