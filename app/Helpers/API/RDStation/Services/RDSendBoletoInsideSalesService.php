...
class RDSendBoletoInsideSalesService {

    const IDENTIFIER = 'gerou-boleto';
    ...
    public function __construct($finBoleto, Clientes $cliente) {
        ...
        //Log::useDailyFiles(storage_path().'/logs/rd-station/boletos-inside-sales/enviados.log');
    }
    ...
    public function saveSent() {
        ...
        $rdStationSent->fill([
            ...
            'identificador' => self::IDENTIFIER,
            'descricao' => 'Inside Sales - Boleto avulso para primeiro pagamento'
        ]);
        $rdStationSent->save();
