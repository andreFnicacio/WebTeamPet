...
+function () {
    var Providers = {
        ...
        build: function build(provider, cep) {
...
+function () {
    ...
    window.vueCancelamentoCobrancas = new Vue({
        ...
        computed: {
            cobrancasNaoSelecionadas: function cobrancasNaoSelecionadas() {
        ...
        methods: {
            buildSelectAcordo: function buildSelectAcordo() {
                if (this.is_acordo) {
...
+function () {
    ...
    window.vueEmissorGuia = new Vue({
        ...
        methods: {
            ...
            loadPets: function loadPets() {
                ...
                this.$http.get('/pet/' + this.microchip).then(function (response) {
                    ...
                    if (_self.pets.length > 0) {
                        ...
                        for (var i = 0; i < _self.procedimentos.length; i++) {
                            var procedimento = $("#procedimentos option[value=" + _self.procedimentos[i].id + "]");
                        ...
                        for (var _i = 0; _i < _self.procedimentosInternacao.length; _i++) {
                            var procedimentosInternacao = $("#tipo_internacao option[value=" + _self.procedimentosInternacao[_i].id + "]");
                            procedimentosInternacao.removeAttr('disabled');
                            procedimentosInternacao.attr('carencia_cumprida', _self.procedimentosInternacao[_i].carencia_cumprida);
                        }
                        var $procedimentosInternacao = $('#tipo_internacao');
                        ...
                        var hideInternForPlans = [74, 75, 76];
                        ...
                        if (_self.selected.statusPagamento !== "Em dia") {
                            swal('Erro', "Esse cliente não poderá emitir guias. Peça para entrar em contato das 9h as 18h pelo chat em nosso site www.lifepet.com.br. Ao entrar em contato, informe o Erro FI-01.", 'error');
                        ...
                        if (!_self.selected.planoHabilitadoParaClinica) {
                            swal('Erro', "Prezado credenciado, informamos que a sua clínica não pode realizar atendimento para esse plano. Oriente o cliente a buscar uma rede compatível com o plano no App Lifepet.", 'error');
            ...
            loadPrestadores: function loadPrestadores() {
            ...
            fillProcedimentos: function fillProcedimentos() {
            ...
            procedimentosCarregados: function procedimentosCarregados() {
                return this.procedimentos;
            },
            procedimentosInternacaoCarregados: function procedimentosInternacaoCarregados() {
                return this.procedimentosInternacao;
            },
            procedimentosSelecionados: function procedimentosSelecionados() {
                var _self = this;
            ...
            isGuiaExame: function isGuiaExame() {
            ...
            totalProcedimentos: function totalProcedimentos() {
                var procedimentos = $('#procedimentos option:selected').toArray();
                var total = 0;
                var _self = this;
                procedimentos.forEach(function (selected) {
...
var TableDatatablesManaged = function () {
    ...
    var initTable = function initTable() {
        ...
        table.dataTable({
            ...
            "bPaging": false,
            "paging": false,
            "lengthMenu": [[20, 35, 50, -1], [20, 35, 50, "Todos"] // change per page values here
            ],
...
+function () {
    ...
    window.vueNotas = new Vue({
        ...
        methods: {
            ...
            excluirNota: function excluirNota(n) {
                var _self = this;
...
+function () {
    ...
    window.vuePlanosProcedimentos = new Vue({
        ...
        methods: {
            hasChanged: function hasChanged(pp, which) {
            ...
            trySave: function trySave(pp, index) {
                this.isSaving = true;
                var _self = this;
            ...
            remove: function remove(pp, index) {
                this.isSaving = true;
                var _self = this;
        ...
        computed: {
            filteredPlanosProcedimentos: function filteredPlanosProcedimentos() {
                var _self = this;
...
+function () {
    ...
    window.topSearch = new Vue({
        ...
        methods: {
            loadSearchables: function loadSearchables() {
            ...
            setCurrent: function setCurrent(searchable) {
