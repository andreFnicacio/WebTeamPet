    ...
    window.vueEmissorGuia = new Vue({
        ...
        methods: {
            loadPets: function loadPets() {
                ...
                var _self = this;
                this.$http.get('/api/v1/pet/' + this.microchip).then(function (response) {
                    ...
                    if (_self.pets.length > 0) {
                        ...
                        if (_self.selected.statusPagamento !== "Em dia") {
                            swal('Erro', "Prezado credenciado, esse cliente encontra-se com problemas no seu cadastro. Peça para ele entrar em contato com a Lifepet. \nNo momento não será possível emitir uma guia.", 'error');
                            _self.microchip = '';
                            _self.selected = {
                                'id': null,
                                'nome_pet': null,
        ...
        methods: {
            ...
            salvar: function salvar() {
                ...
                this.$http.post('/notas/' + this.idCliente, this.nota).then(function (response) {
                    ...
                    console.error("Error trying to retrieve data on '/notas/'" + _self.microchip);
                });
            }
        },
        mounted: function mounted() {
