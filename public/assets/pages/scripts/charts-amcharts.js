...
var initChartSample100 = function() {
        var chart = AmCharts.makeChart("chart_100", {
            "type": "serial",
            "theme": "light",
            "language": "pt",
            "pathToImages": App.getGlobalPluginsPath() + "amcharts/amcharts/images/",
            ...
            "dataProvider": [{
                "year": '01/07',
                "income": 20,
                "cancelamentos": 1450.1
            }, {
                "year": '02/07',
                "income": 1450.80,
                "cancelamentos": 2232.8
            }, {
                "year": '03/07',
                "income": 2550.80,
                "cancelamentos": 1500.9
            }, {
                "year": '04/07',
                "income": 2150.80,
                "cancelamentos": 2232.1
            }, {
                "year": '05/07',
                "income": 3000.80,
                "cancelamentos": 1350.2,
                "dashLengthLine": 5
            }, {
                "year": '06/07',
                "income": 1250.80,
                "cancelamentos": 1350.9,
                "dashLengthColumn": 5,
                "alpha": 0.2,
                "additional": "(projeção)"
            }],
        ...
        $('#chart_100').closest('.portlet').find('.fullscreen').click(function() {
            chart.invalidateSize();
        });
