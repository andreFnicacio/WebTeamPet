...
@section('content')
    ...
    <div class="portlet light portlet-fit portlet-form ">
        <div class="portlet-title">
            ...
            <div class="actions" data-target="#Permissoes">
        ...
        <div class="portlet-body">
            <!-- BEGIN FORM-->
            {!! Form::open(['route' => ['permissoes.store'], 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'Permissoes']) !!}
                <div class="form-body">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var $actions = $('.actions[data-target="#Permissoes"');
            ...
            $actions.find('#cancel').click(function() {
                var target = $actions.attr('data-target');
                location.href = "{!! route('permissoes.index') !!}";
                return;
            });
        });
    </script>
