                    ...
                    <div class="topolife row">
                        ...
                        <table style="width: 100%;" class="dadosgerais">
                            ...
                            <tr>
                                ...
                                <td style="width: 80%;" class="texto" contenteditable="true"> </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="topolife row">
                        ...
                        <table style="width: 100%;" class="dadosgerais">
                            ...
                            <tr>
                                ...
                                <td style="width: 25%;" class="texto" >R$ {{ \App\Helpers\Utils::money($pet->petsPlanos()->first()->adesao) }}</td>
                        ...
                        <ul class="doencaspet">
                            <li>
                                ...
                                <b>{{ isset($request['questao-1-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-1']) ? ' - ' . $request['espeficicacao-1'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) de alguma tipo de neoplasia (câncer)?
                                <b>{{ isset($request['questao-2-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-2']) ? ' - ' . $request['espeficicacao-2'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) de alguma doença no sangue (anemias)?
                                <b>{{ isset($request['questao-3-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-3']) ? ' - ' . $request['espeficicacao-3'] : '' }}</b>
                            </li>
                            <li>
                                É portador(a) de alguma doença endócrina (diabetes, hiperadrenocorticismo, hipotireoidismo, entre outras)?
                                <b>{{ isset($request['questao-4-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-4']) ? ' - ' . $request['espeficicacao-4'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) de alguma doença do sistema nervoso (convulsões, ataxias, entre outras)?
                                <b>{{ isset($request['questao-5-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-5']) ? ' - ' . $request['espeficicacao-5'] : '' }}</b>
                            </li>
                            <li>
                                Alguma afecção dermatológica? (atopia, DAPE, Sarna)?
                                <b>{{ isset($request['questao-6-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-6']) ? ' - ' . $request['espeficicacao-6'] : '' }}</b>
                            </li>
                            <li>
                                É portador de alguma enfermidade circulatória(sopro, arritmia, hipertensão)?
                                <b>{{ isset($request['questao-7-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-7']) ? ' - ' . $request['espeficicacao-7'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) algum problema em ouvido?
                                <b>{{ isset($request['questao-8-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-8']) ? ' - ' . $request['espeficicacao-8'] : '' }}</b>
                            </li>
                            <li>
                                ...
                                <b>{{ isset($request['questao-9-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-9']) ? ' - ' . $request['espeficicacao-9'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) de doenças do aparelho digestivo (gastrite, úlceras, diarreias, corpo estranho)?
                                <b>{{ isset($request['questao-10-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-10']) ? ' - ' . $request['espeficicacao-10'] : '' }}</b>
                            </li>
                            <li>
                                ...
                                <b>{{ isset($request['questao-11-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-11']) ? ' - ' . $request['espeficicacao-11'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) algum tipo de fratura ou traumatismo?
                                <b>{{ isset($request['questao-12-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-12']) ? ' - ' . $request['espeficicacao-12'] : '' }}</b>
                            </li>
                            <li>
                                Realizou algum procedimento cirúrgico para correção ortopédica (fratura ou traumatismo)?
                                <b>{{ isset($request['questao-13-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-13']) ? ' - ' . $request['espeficicacao-13'] : '' }}</b>
                            </li>
                            <li>
                                Realizou algum tipo de procedimento cirúrgico?
                                <b>{{ isset($request['questao-14-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-14']) ? ' - ' . $request['espeficicacao-14'] : '' }}</b>
                            </li>
                            <li>
                                Sofre de alguma má formação congênita?
                                <b>{{ isset($request['questao-15-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-15']) ? ' - ' . $request['espeficicacao-15'] : '' }}</b>
                            </li>
                            <li>
                                Sofre(u) algum tipo de doença não relacionada acima?
                                <b>{{ isset($request['questao-16-'.$pet->id]) ? 'Sim' : 'Não' }} {{ isset($request['espeficicacao-16']) ? ' - ' . $request['espeficicacao-16'] : '' }}</b>
                            </li>
                        </ul>
