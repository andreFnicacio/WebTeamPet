        ...
        <div class="col-sm-12 no-print">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" action="{{ route('relatorios.receitas-link-pagamento') }}" method="GET" >
                        <div class="form-body">
        ...
        <div class="col-sm-12">
            <div class="portlet light bordered">
                <div class="portlet-title" style="border-bottom: 0">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="{{ route('relatorios.receitas-link-pagamento.download') }}?{{ http_build_query(array_merge($_GET, ['format' => 'xlsx'])) }}" download>
                    ...
                    <div class="row">
                        <div class="col-sm-12 only-print" style="padding: 0">
                            <div class="col-sm-6">
                                <h2>Relatório de Receitas - Links de Pagamento</h2>
                ...
                <div class="portlet-body">
                    @include('relatorios.parts.receitas-link-pagamento.table', ['receitas' => $receitas])
                </div>
            </div>
        </div>
