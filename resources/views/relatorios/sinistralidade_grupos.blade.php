...
@section('title')
    @parent
    - Sinistralidade de Grupos Médicos
@endsection
        ...
        <div class="col-sm-12 no-print">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" action="{{ route('relatorios.sinistralidadeGrupos') }}" method="GET">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 pull-left">
                                    <h4>Grupos Hospitalares</h4>
                                    <div class="input-group">
                                        <span class="input-group-addon input-left">
                                            <i class="fa fa-hospital-o"></i>
                                        </span>
                                        <select name="grupos_hospitalares[]" id="grupos_hospitalares"
                                                class="form-control select2" multiple="multiple">
                                            @foreach(\App\Models\GrupoHospitalar::all() as $grupoHospitalar)
                                                <option value="{{ $grupoHospitalar->id }}"
                                                        {{ \App\Http\Controllers\RelatoriosController::setSelected($grupoHospitalar->id, $params, 'grupos_hospitalares') }}>
                                                    {{ $grupoHospitalar->id }} - {{ $grupoHospitalar->nome_grupo }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
        ...
        <div class="col-sm-12">
            <div class="portlet light bordered">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="{{ route('relatorios.sinistralidade.download') }}?{{ http_build_query(array_merge($_GET, ['format' => 'csv'])) }}"
                                       download>
                ...
                <div class="portlet-body">
                    @include('relatorios.parts.sinistralidade.table_grupos', ['guias' => $guias])
                </div>
            </div>
        </div>
