        ...
        <div class="col-sm-12 no-print">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" action="{{ route('relatorios.pets') }}" method="GET" >
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <span class="input-group-addon input-left">
                                        ...
                                        <select name="planos[]" id="pet_planos" class="form-control select2" multiple="multiple">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <span class="input-group-addon input-left">
                                        ...
                                        <select name="clientes[]" id="clientes" class="form-control select2" multiple="multiple">
                                            <option value="0">Todos</option>
        ...
        <div class="col-sm-12">
            <div class="portlet light bordered">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="{{ route('relatorios.pets.download') }}?{{ http_build_query(array_merge($_GET, ['format' => 'xlsx'])) }}" download>
                ...
                <div class="portlet-body">
                    @include('relatorios.parts.pets.table', ['pets' => $pets])
                </div>
            </div>
        </div>
