        ...
        <div class="col-sm-12 no-print">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" action="{{ route('relatorios.vendedores') }}" method="GET" >
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <span class="input-group-addon input-left">
                                        ...
                                        <select name="vendedores[]" id="vendedores" class="form-control select2" multiple="multiple">
                                            @foreach(\App\Models\Vendedores::all() as $vendedor)
                                                <option value="{{ $vendedor->id }}"
                                                        {{ \App\Http\Controllers\RelatoriosController::setSelected($vendedor->id, $params, 'vendedores') }}>
        ...
        <div class="col-sm-12">
            <div class="portlet light bordered">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="{{ route('relatorios.vendedores.download') }}?{{ http_build_query(array_merge($_GET, ['format' => 'xlsx'])) }}" download>
                ...
                <div class="portlet-body">
                    @include('relatorios.parts.vendedores.table', ['vendas' => $vendas])
                </div>
            </div>
        </div>
