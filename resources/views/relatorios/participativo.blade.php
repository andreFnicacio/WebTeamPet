        ...
        <div class="col-sm-12 no-print">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form role="form" action="{{ route('relatorios.participativo') }}" method="GET">
                        <div class="form-body">
        ...
        <div class="col-sm-12">
            <div class="portlet light bordered">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="{{ route('relatorios.participativo.download') }}?{{ http_build_query(array_merge($_GET, ['format' => 'xlsx'])) }}"
                                       download>
                ...
                <div class="portlet-body">
                    @include('relatorios.parts.participativo.table', ['guias' => $guias])
                </div>
            </div>
        </div>
