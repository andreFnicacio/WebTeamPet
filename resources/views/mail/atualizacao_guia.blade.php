                            ...
                            <table class="mcnImageContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                ...
                                <tr>
                                    <td class="mcnImageContent" style="padding-right: 0px;padding-left: 0px;padding-top: 0;padding-bottom: 0;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" valign="top">
                                        <img alt="" src="https://gallery.mailchimp.com/214ba425b8a86ab244a9ff1db/images/f3a565ee-7e7f-4b26-9fda-4abc1c7b1870.jpg" style="max-width: 600px;padding-bottom: 0;display: inline !important;vertical-align: bottom;border: 0;height: auto;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" class="mcnImage" width="600" align="middle">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <tr>
                                    <td class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;" valign="top">
                                        <h1 style="display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;"><br>
                                            <span style="color:#000000">Guia: {{ $numero_guia }}<br>
                                                Status: <strong>{{ $status_guia }}</strong></span>
                                        </h1>
                                        <h5>Data: {{ $data }} às {{ $hora }}</h5>
                                        <br>
                                        @if($status_guia === "LIBERADO")
                                            Prezado credenciado, informamos que a guia {{ $numero_guia }} foi liberada pela auditoria da Lifepet. Caso tenha dúvidas, entre em contato com o atendimento.
                                        @else
                                            Prezado credenciado, informamos que a guia {{ $numero_guia }} foi negada pela auditoria da Lifepet. Caso tenha dúvidas, entre em contato com o atendimento.
                                        @endif
                                        <p style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">Atenciosamente,<br>
                                            Equipe Lifepet<br>
                                            (27) 4003-6074<br>
