                                ...
                                <tr>
                                    <td class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;" valign="top">
                                        <h1 style="display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;"><br>
                                            <span style="color:#000000">Você está quase Lá!</span>
                                        </h1>
                                        <p>Olá {{$nome}},</p>

                                        <p>Estamos muito felizes de ter você e seu filhote conosco!</p>

                                        <p>Espere só mais um pouquinho, ok? Agora precisaremos conhecer um pouco mais sobre você e seus pets. Responda esse e-mail com os seguintes dados:</p>

                                        <h4>Dados de endereço:</h4>
                                        Rua e número residencial:<br/>
                                        Complemento:<br/>
                                        Bairro:<br/>
                                        Cidade:<br/>
                                        UF:<br/>
                                        <br>
                                        <h4>Dados do(s) pet(s)*:</h4>
                                        Nome do pet:<br/>
                                        Idade:<br/>
                                        Sexo:<br/>
                                        Raça:<br/>
                                        Cite as doenças pré-existentes (caso existam):<br/>
                                        <br><br>
                                        <p>*Se você tem mais de um pet, duplique essa lista na resposta.</p>
                                        <br><br>
                                        IMPORTANTE: Anexe uma foto do seu RG (Frente e Verso), um comprovante de residência e a carteirinha de vacinação.
                                        <br><br>

                                        <p>Caso a sua documentação seja aprovada você será convidado a microchipar seu pet e estará apto a utilizar o plano quando quiser! 😉</p>

                                        <p>Um abraço,<br/>
                                        Equipe Lifepet<br/><br/></p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
