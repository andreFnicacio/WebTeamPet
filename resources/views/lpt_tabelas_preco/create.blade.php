...
@section('content')
    ...
    <div class="portlet light portlet-fit portlet-form ">
        <div class="portlet-title">
            ...
            <div class="actions" data-target="#lptTabelaPreco">
        ...
        <div class="portlet-body">
            <!-- BEGIN FORM-->
            {!! Form::open(['route' => ['lifepet-para-todos.tabelas-preco.salvar'], 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'lptTabelaPreco']) !!}
                <div class="form-body">
                    ...
                    @include('lpt_tabelas_preco.fields')
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var $actions = $('.actions[data-target="#lptTabelaPreco"]');
            ...
            $actions.find('#cancel').click(function() {
                var target = $actions.attr('data-target');
                location.href = "{!! route('lifepet-para-todos.tabelas-preco.listar') !!}";
                return;
            });
        });
    </script>
