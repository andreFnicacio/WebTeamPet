...
<head>
    <meta charset="utf-8" />
    <title>Lifepet Manager | Área do Cliente</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link href="{{ url('/') }}/assets/global/plugins/intro.min.css" rel="stylesheet" type="text/css" />
    ...
    <div class="row bs-reset">
        <div class="col-md-6 login-container bs-reset">
            ...
            <div class="login-content">
                <h1>Olá, Cliente.</h1>
                @include('common.swal')
                <p>Seja bem-vindo ao seu novo painel exclusivo da Lifepet. Feito sob medida para deixar nosso atendimento cada vez mais transparente. </p>
