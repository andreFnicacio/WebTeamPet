...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" method="post" action="{{ url('/password/email') }}" method="post" style="padding-bottom: 50px;">
        {{ csrf_field() }}
        ...
        <div class="form-actions">
            <button type="submit" class="btn blue pull-right"> Solicitar </button>
        </div>
    </form>
