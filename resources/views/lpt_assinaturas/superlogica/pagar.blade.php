                        ...
                        <form action="#" method="POST" id="form-pagamento">
                            ...
                            <div class="row">
                                <div class="col-md-4" id="dados">
                                    <div class="box-pagamento box-shadow">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datetime datetimepicker" id="data_nascimento" autocomplete="off"  value="" required="required" name="data_nascimento" placeholder="DD/MM/YYYY">
                                        </div>
                                        <div class="form-group">
                                            <label for="sexo">Gênero:</label>
                                            <select required="required" name="sexo" id="sexo" class="form-control">
                                                <option value=""></option>
                                ...
                                <div class="col-md-4" id="pagamento1">
                                    <div class="box-pagamento box-shadow">
                                        ...
                                        <div class="form-group hide-on-total-discount">
                                            ...
                                            <input type="text" class="form-control" id="payment_type" required="required" name="payment_type" placeholder="" value="CARTAO" readonly="readonly">
                                        </div>
                                        <div class="form-group hide-on-total-discount">
                                        ...
                                        <div class="row  hide-on-total-discount">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control card-data" id="cvv" name="cvv" required="required" placeholder="000" maxlength="4">
                                                </div>
                                ...
                                <div class="col-md-4" id="resumo">
                                    <div class="box-pagamento box-shadow">
                                        <h4 class="text-center">Dados dos pets</h4>
                                        @for($i = 1; $i <= $pets; $i++)
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <span class="badge badge-info" style="background-color: #6e64ec">Pet #{{$i}}</span>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="pets[{{$i-1}}][nome_pet]" required="required" name="pets[{{$i-1}}][nome_pet]" placeholder="Thor">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="data_nascimento">Nascimento:</label>
                                                            <input type="text" class="form-control datetime datetimepicker" id="pets[{{$i-1}}][data_nascimento]" autocomplete="off"  value="" required="required" name="pets[{{$i-1}}][data_nascimento]" placeholder="DD/MM/YYYY">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select required="required" name="pets[{{$i-1}}][tipo]" id="pets[{{$i-1}}][tipo]" class="form-control">
                                                                <option value=""></option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select required="required" name="pets[{{$i-1}}][sexo]" id="pets[{{$i-1}}][sexo]" class="form-control">
                                                                <option value=""></option>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select required="required" name="pets[{{$i-1}}][raca]" id="pets[{{$i-1}}][raca]" class="form-control select2">
                                                                <option value=""></option>
                                                                @foreach($racas as $r)
                                                                    <option value="{{ $r->id }}">{{ $r->tipo . ' - ' . $r->nome }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
        ...
        jQuery(document).ready(function() {
                    ...
                    success: function(data) {
                        if(data.exists) {
                            ...
                            return setTimeout(function () {
                                return window.location = "https://wa.me/551149502299";
                            }, 3000);
                        }
                        console.log(data);
                    },
            ...
            jQuery('#form-pagamento').submit(function(e) {
                ...
                grecaptcha.execute('{{ getenv('RECAPTCHA_SITE_KEY') }}', {action: 'assinatura_lpt'}).then(function(token) {
                    ...
                    jQuery.ajax({
                        url: '{{ route('api.assinaturas.v4.assinar') }}',
                        dataType: 'json',
                        type: 'POST',
                        data: $fields,
                        beforeSend: function() {
            ...
            (function(){
                jQuery('#cvv').maskLife('0000', {
                    'placeholder': '000'
                });
                jQuery('#expires_in').maskLife('00/00', {
                    'placeholder': '00/00'
                });
                jQuery('#cep').maskLife('00000-000');
                jQuery('#cpf').maskLife('000.000.000-00', {
                    'placeholder': '000.000.000-00'
                });

                var options =  {
                    onKeyPress: function(cardNumber, e, field, options) {
                        var masks = ['0000 0000 0000 0000 0000', '000000 0000 0000 0000'];
                        var mask = (cardNumber.length > 19) ? masks[1] : masks[0];
