...
@section('content')
    ...
    <div class="portlet light portlet-fit portlet-form ">
        <div class="portlet-title">
            ...
            <div class="actions" data-target="#parametros">
        ...
        <div class="portlet-body">
            <!-- BEGIN FORM-->
            {!! Form::open(['route' => ['parametros.store'], 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'parametros']) !!}
                <div class="form-body">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var $actions = $('.actions[data-target="#parametros"]');
            ...
            $actions.find('#cancel').click(function() {
                var target = $actions.attr('data-target');
                location.href = "{!! route('parametros.index') !!}";
                return;
            });
        });
    </script>
